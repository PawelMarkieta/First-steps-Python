...
print(article.split(" "))
print('\nword python appears', article.lower().count(" python "), 'times')

print('\nto print \\ you need to put \\ twice in your text like this: \\\\')
...
print('USD\t\t', 4.23, '\t\t', (amountPLN / 4.23))

ValueAsText = '123.45'
factor = 1.23
print('Value is ', float(ValueAsText), 'factor is', factor, 'value*factor=', (float(ValueAsText) * factor) )